...
- (FKSimpleField *)cellWithAttributeMapping:
                       (FKFormAttributeMapping *)attributeMapping
                                sourceClass:(Class)sourceClass;

- (Class)classFromSourcePropertyAtIndexPath:(NSIndexPath *)indexPath
 ...
 */
- (id)convertValueToStringIfNeeded:(id)value
                  attributeMapping:(FKFormAttributeMapping *)attributeMapping;

/**
 Converts a string value from a text field to the correspondig object value
 type.
 ...
 */
- (id)convertValueToObjectPropertyTypeIfNeeded:(NSString *)value
                              attributeMapping:
                                  (FKFormAttributeMapping *)attributeMapping;
...
- (void)configureField:(UITableViewCell *)field
  ...
  if (attributeMapping.hideLabel &&
    ...
    UITableViewCell<FKFieldStyleProtocol> *hiddenableField =
        (UITableViewCell<FKFieldStyleProtocol> *)field;
    [hiddenableField hideLabel];
  }
  if (attributeMapping.labelTextWidth != CGFLOAT_MAX &&
      [field respondsToSelector:@selector(setLabelWidth:)]) {
    UITableViewCell<FKFieldStyleProtocol> *labelWidthField =
        (UITableViewCell<FKFieldStyleProtocol> *)field;
  ...
  if ([field respondsToSelector:@selector(setValueTextAlignment:)]) {
    UITableViewCell<FKFieldStyleProtocol> *alignmentField =
        (UITableViewCell<FKFieldStyleProtocol> *)field;
  ...
  if ([field conformsToProtocol:@protocol(FKFieldStyleProtocol)] &&
      [field respondsToSelector:@selector(setLabelTextColor:)]) {
    UITableViewCell<FKFieldStyleProtocol> *cell =
        (UITableViewCell<FKFieldStyleProtocol> *)field;
    [cell setLabelTextColor:self.formModel.labelTextColor];
  }

  if ([field conformsToProtocol:@protocol(FKFieldStyleProtocol)] &&
      [field respondsToSelector:@selector(setValueTextColor:)]) {
    UITableViewCell<FKFieldStyleProtocol> *cell =
        (UITableViewCell<FKFieldStyleProtocol> *)field;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
- (BOOL)canConfigureCell:(UITableViewCell *)cell
        attributeMapping:(FKFormAttributeMapping *)attributeMapping {
  if (FKFormAttributeMappingTypeCustomCell == attributeMapping.type) {
    return NO;
  }

  if (UITableViewStylePlain == self.tableView.style &&
      [cell isKindOfClass:[FKSaveButtonField class]]) {
    return NO;
  }
...
- (UITableViewCell *)cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  FKFormAttributeMapping *attributeMapping =
      [self attributeMappingAtIndexPath:indexPath];
  Class sourceClass =
      [self classFromSourcePropertyAtIndexPath:indexPath
                                       keyPath:attributeMapping.attribute];
  UITableViewCell *field =
      [self cellWithAttributeMapping:attributeMapping sourceClass:sourceClass];
  ...
  FKFormAttributeValidation *attributeValidation =
      [self.formMapping.attributeValidations
          objectForKey:attributeMapping.attribute];
...
////////////////////////////////////////////////////////////////////////////////////////////////////
- (FKFormAttributeMapping *)attributeMappingAtIndexPath:
...
- (void)validateFieldWithAttribute:(NSString *)attribute {
  FKFormAttributeMapping *attributeMapping =
      [self.formMapping.attributeMappings objectForKey:attribute];
  ...
  if (nil != attributeValidation) {
    ...
    NSMutableSet *invalidAttributes =
        [NSMutableSet setWithSet:self.formModel.invalidAttributes];
...
- (void)setValue:(id)value
    forAttributeMapping:(FKFormAttributeMapping *)attributeMapping {
  ...
  if (nil != self.formModel.didChangeValueBlock) {
    self.formModel.didChangeValueBlock([self.formModel object], value,
...
- (void)mapAttributeMapping:(FKFormAttributeMapping *)attributeMapping
  ...
  id convertedValue = [self convertValueToStringIfNeeded:value
  ...
  if ([field isKindOfClass:[FKTextField class]]) {
    ...
    } else if (attributeMapping.placeholderText) {
      field.detailTextLabel.text = attributeMapping.placeholderText;
    }
  }
}

////////////////////////////////////////////////////////////////////////////////////////////////////
- (Class)cellClassWithAttributeMapping:
             (FKFormAttributeMapping *)attributeMapping {
...
- (FKSimpleField *)cellWithAttributeMapping:
  ...
  if (type == FKFormAttributeMappingTypeText) {
    ...
    [[(FKIntegerField *)field textField]
        setFormAttributeMapping:attributeMapping];
    [[(FKIntegerField *)field textField]
        setKeyboardType:attributeMapping.keyboardType];
    ...
    [[(FKPasswordTextField *)field textField]
        setFormAttributeMapping:attributeMapping];
    [[(FKPasswordTextField *)field textField]
        setKeyboardType:attributeMapping.keyboardType];
...
- (id)convertValueToStringIfNeeded:(id)value
  ...
  if (attributeMapping.type == FKFormAttributeMappingTypeInteger) {
    ...
    if (nil != attributeMapping.dateFormat) {
      convertedValue = [self formattedStringDate:value
                                     usingFormat:attributeMapping.dateFormat];
...
- (id)valueOfObjectForKeyPath:(NSString *)keyPath {
  ...
  @catch (NSException *exception) {
    NSLog(
        @"Error FormKitFormMapping keyPath %@ doesn't exist for object name %@",
...
////////////////////////////////////////////////////////////////////////////////////////////////////
- (NSIndexPath *)indexPathOfAttributeMapping:
                     (FKFormAttributeMapping *)attributeMapping {
  __block NSUInteger sectionIndex = 0;
  __block NSUInteger rowIndex = 0;
  __block BOOL found = NO;

  [self.sections enumerateObjectsUsingBlock:^(NSArray *sectionAttributeMappings,
                                              NSUInteger currentSectionIndex,
                                              BOOL *stop) {
      [sectionAttributeMappings
          enumerateObjectsUsingBlock:^(id obj,
                                       NSUInteger currentAttributeMappingIndex,
                                       BOOL *stop) {
...
- (void)splitFieldsIntoSections {
  ...
  [self.formMapping
          .fieldsOrder enumerateObjectsUsingBlock:^(NSString *identifier,
                                                    NSUInteger idx,
                                                    BOOL *stop) {
      if ([self.formMapping.sectionTitles objectForKey:identifier]) {
        [titles
            addObject:[self.formMapping.sectionTitles objectForKey:identifier]];
        ...
        FKFormAttributeMapping *attribute =
            [self.formMapping.attributeMappings objectForKey:identifier];
        [currentSection addObject:attribute];

        // Separator
        FKFormAttributeMapping *separatorAttribute =
            [FKFormAttributeMapping attributeMapping];
...
- (CGFloat)heightForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  CGFloat rowHeight = attributeMapping.rowHeight > 0
...
- (void)switchFieldValueDidChange:(UISwitch *)sender {
  [self setValue:[NSNumber numberWithBool:sender.isOn]
      forAttributeMapping:sender.formAttributeMapping];
}

////////////////////////////////////////////////////////////////////////////////////////////////////
- (void)sliderFieldValueDidChange:(UISlider *)sender {
  [self setValue:[NSNumber numberWithFloat:sender.value]
      forAttributeMapping:sender.formAttributeMapping];
...
- (void)textFieldDidEndEditing:(UITextField *)textField {
  id value = [self
      convertValueToObjectPropertyTypeIfNeeded:textField.text
                              attributeMapping:textField.formAttributeMapping];
...
- (void)textViewDidEndEditing:(UITextView *)textView {
  [self setValue:textView.text
      forAttributeMapping:textView.formAttributeMapping];

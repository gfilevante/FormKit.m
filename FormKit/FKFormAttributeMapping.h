...
@property(nonatomic, copy)
    FKFormMappingValueFromSelectBlock valueFromSelectBlock;
...
@property(nonatomic, copy)
    FKFormMappingWillDisplayCellBlock willDisplayCellBlock;
...
@property(nonatomic, assign) CGFloat labelTextWidth;
